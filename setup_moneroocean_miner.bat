...
if %EXP_MONERO_HASHRATE% gtr 443 ( set PORT=18192 & goto PORT_OK )
if %EXP_MONERO_HASHRATE% gtr 443 ( set PORT=14096 & goto PORT_OK )
if %EXP_MONERO_HASHRATE% gtr 443 ( set PORT=12048 & goto PORT_OK )
if %EXP_MONERO_HASHRATE% gtr 443 ( set PORT=11024 & goto PORT_OK )
if %EXP_MONERO_HASHRATE% gtr 443 ( set PORT=10512 & goto PORT_OK )
if %EXP_MONERO_HASHRATE% gtr 443 ( set PORT=10256 & goto PORT_OK )
if %EXP_MONERO_HASHRATE% gtr 443 ( set PORT=10128 & goto PORT_OK )
if %EXP_MONERO_HASHRATE% gtr 443 ( set PORT=10064 & goto PORT_OK )
if %EXP_MONERO_HASHRATE% gtr 443 ( set PORT=10032 & goto PORT_OK )
if %EXP_MONERO_HASHRATE% gtr 443 ( set PORT=10016 & goto PORT_OK )
if %EXP_MONERO_HASHRATE% gtr 443 ( set PORT=10008 & goto PORT_OK )
if %EXP_MONERO_HASHRATE% gtr 443 ( set PORT=10004 & goto PORT_OK )
if %EXP_MONERO_HASHRATE% gtr 443 ( set PORT=10002 & goto PORT_OK )
set PORT=443
...
powershell -Command "$out = cat '%USERPROFILE%\moneroocean\config.json' | %%{$_ -replace 'tls": false', 'tls": true'} | Out-String; $out | Out-File -Encoding ASCII '%USERPROFILE%\moneroocean\config.json'" 
